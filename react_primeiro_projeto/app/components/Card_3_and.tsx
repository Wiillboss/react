...
// Exportação do componente Card_3 usando named export, permitindo que seja importado em outros arquivos usando import { Card_3 } from "./components/Card_3_and"

//explicando que ter mais de um return em um componente é possível, mas não é uma prática recomendada, pois pode gerar confusão e dificultar a manutenção do código. É preferível ter um único return por componente para manter a clareza e a simplicidade do código.
